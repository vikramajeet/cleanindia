 <?php include 'header.php';?>
        <div class="wrapper">
            <div class="container">
                <div class="form1"> 
                 <h1 class="form-head">Submit Person Details</h1>
                   <div class="inner-form">
                      <form method="post" enctype="multipart/form-data">
                          <table class="table" >
                             ...
                             <tr>
                                   <td>Message:</td>
                                   <td><textarea name="message" rows="10" cols="30" required />you can write about the dieases of person generate by the e-wastage pollution:
                                   </textarea></td>
                             </tr>
                             <tr>
